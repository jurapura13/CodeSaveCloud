<!--
This header shows up if SESSION:LOGIN is NOT found.
-->
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0 ">
                <li class="nav-item d-none d-lg-flex">
                    <a class="nav-link" href="<?php echo URL; ?>">Why CodeSave?</a>
                </li>
                <li class="nav-item d-none d-lg-flex">
            ...
            <ul class="navbar-nav mb-2 mb-lg-0 d-none d-lg-flex align-items-center">
                <li class="nav-item">
                    <a class="btn btn-sm btn-outline-secondary mx-3" href="<?php echo URL; ?>login">
                        Login
                    </a>

                </li>
                <li class="nav-item">
                    <a class="btn btn-sm btn-outline-primary" href="<?php echo URL; ?>signup">
                        Signup
                    </a>
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0 d-block d-lg-none">
                ...
                <li class="nav-item"><a class="nav-link" href="<?php echo URL; ?>">About</a></li>
                <li class="nav-item"><a class="nav-link" href="<?php echo URL; ?>">Explore</a></li>
                <hr class="nav-divider">
                <li class="nav-item">
                    <a class="btn btn-outline-secondary mb-1 w-100" href="<?php echo URL; ?>login">
                        Login
                    </a>

                </li>
                <li class="nav-item">
                    <a class="btn btn-outline-primary w-100" href="<?php echo URL; ?>signup">
                        Signup
                    </a>
